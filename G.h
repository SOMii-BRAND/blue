...
def tik():
    titik = [
     '   ', '.  ', '.. ', '...', '.. ', '.  ', '   ']
    for o in titik:
        print '\r\x1b[1;91m     [ðŸ•—] \x1b[1;92mLoa\x1b[1;90mding \x1b[1;97m' + o,
        sys.stdout.flush()
        time.sleep(0.5)
...
def lodhirt():
    lodhirt = [
     'im', '      ', 'Ima', '                   ', 'BRAND', '      ', 'BOY', '      ', 'SOMI', '      ', 'SUCCESS', '      ', 'BLUE', '      ', 'PAINT ', '      ', 'DEATH', '      ', 'ROUTE', 'SOMI BRAND', '      ', 'TO', '      ', 'MUCH', '      ', 'ATTITUDE', '      ', 'SOMI BRAND', '      ', 'SOMI BRAND', '      ', 'SOMI BRAND', '      ', 'SOMI BRAND', '      ', 'SOMI BRAND', '      ', 'SOMI STAR BOY\n']
    for o in lodhirt:
